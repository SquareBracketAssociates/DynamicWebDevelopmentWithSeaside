...
[Dynamic Web Development with Seaside] book. You can find the original PDF in the repository.
...
3. We should get a chapter on Bootstrap and MDL, probably one on WebSocket usage.
