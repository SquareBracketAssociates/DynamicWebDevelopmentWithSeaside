...
\newenvironment{advanced}{\begin{center}\begin{minipage}{8cm}
\textbf{Advanced:}}{\end{minipage}\end{center}}

\newenvironment{important}{\begin{center}\begin{minipage}{8cm}
\textbf{Important:}}{\end{minipage}\end{center}}
